...
<template>
    ...
    <div style="width: 15%;height: 800px;;" class="card flex justify-content-center">
        <Menu :model="items" class="w-full md:w-15rem">
            ...
            <template #end>
                <button v-ripple
                    class="relative w-full p-link flex align-items-center p-2 pl-3 text-color hover:surface-200 border-noround">
